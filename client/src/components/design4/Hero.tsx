...
//               <div className="h-[450px] relative rounded-full overflow-hidden">
//                 <img 
//                   src={fashionImages.design4.hero.main} 
//                   alt="Luxury fashion collection" 
//                   className="w-full h-full object-cover"
//                 />
//                 <div className="absolute inset-0 bg-gradient-to-br from-transparent to-[hsl(var(--design4-accent))/30]"></div>
//               </div>
//             </div>
...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      ref={heroRef}
      className="min-h-screen relative overflow-hidden bg-gradient-to-br from-[rgba(76,29,149,0.9)] to-[rgba(116,63,175,0.8)]"
      // Purple dark gradient with opacity for better contrast
    >
      {/* Decorative elements */}
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute top-0 right-0 w-1/2 h-full bg-[rgba(147,112,219,0.1)] backdrop-blur-3xl rounded-bl-full"></div>
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.15 }}
          transition={{ duration: 1, delay: 0.5 }}
          className="absolute top-1/4 left-1/4 w-96 h-96 rounded-full bg-[rgba(147,112,219,0.15)] filter blur-3xl"
        ></motion.div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10 h-screen flex flex-col justify-center">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="overflow-hidden mb-4">
              <motion.div
                ...
                className="w-32 h-1 bg-purple-400"
              />
            </div>

            <motion.h4
              variants={itemVariants}
              className="text-purple-400 text-sm uppercase tracking-[0.3em] mb-4 font-medium"
            >
              Distinctive Luxury
            </motion.h4>
            ...
            <motion.p
              variants={itemVariants}
              className="text-xl text-purple-100 mb-10 max-w-lg"
            >
              Experience luxury that defies convention, where visionary design
              meets uncompromising quality in every meticulously crafted piece.
            </motion.p>
            ...
            >
              <a
                href="#showcase"
                className="relative overflow-hidden group px-8 py-4 bg-transparent text-purple-200 text-sm uppercase tracking-wider font-medium border border-purple-400 hover:text-purple-900 hover:bg-purple-400 transition-colors duration-300 inline-flex items-center justify-center"
              >
                <span className="relative z-10">Discover Collections</span>
                <div className="absolute inset-0 bg-purple-400 transform -translate-x-full group-hover:translate-x-0 transition-transform duration-300"></div>
              </a>

              <a
                href="#about"
                className="relative overflow-hidden group px-8 py-4 bg-purple-900/10 backdrop-blur-sm text-purple-200 text-sm uppercase tracking-wider font-medium hover:bg-purple-900/20 transition-all inline-flex items-center justify-center"
              >
                Our Philosophy
          ...
          >
            <div className="relative">
              <div className="absolute -inset-4 bg-gradient-to-r from-purple-400/30 to-transparent rounded-full blur-lg"></div>
              <div className="h-[450px] relative rounded-full overflow-hidden shadow-lg shadow-purple-900/40">
                <img
                  src={fashionImages.design4.hero.main}
                  alt="Luxury fashion collection"
                  className="w-full h-full object-cover"
                />
                <div className="absolute inset-0 bg-gradient-to-br from-transparent to-purple-900/20"></div>
              </div>
            </div>
            ...
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 1.5 }}
              className="absolute -bottom-10 right-10 bg-purple-900/80 backdrop-blur-md p-4 rounded-lg border border-purple-600"
            >
              <span className="block text-purple-200 text-sm font-medium">
                New Collection
              </span>
              <span className="block text-purple-400 font-bold">AVANT 2023</span>
            </motion.div>
          </motion.div>
        </div>
        ...
        <motion.div
          ...
          className="absolute bottom-10 left-1/2 -translate-x-1/2 text-purple-300"
        >
